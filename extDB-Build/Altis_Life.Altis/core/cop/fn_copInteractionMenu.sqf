...
if(!((player distance (getMarkerPos "cop_jail") < 30) OR  (player distance (getMarkerPos "cop_jail_1") < 30) OR (player distance (getMarkerPos "cop_jail_2") < 30) OR (player distance (getMarkerPos "cop_jail_3") < 30) OR  (player distance (getMarkerPos "cop_jail_4") < 30) OR  (player distance (getMarkerPos "cop_jail_5") < 30))) then 
{
